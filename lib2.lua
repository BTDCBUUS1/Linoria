...
do
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        function Dropdown:AddValue(Value)
            ...
            if table.find(Dropdown.Values, Value) then return end
            
            table.insert(Dropdown.Values, Value)
            Dropdown:BuildDropdownList()
            
            if Dropdown.Multi and next(Dropdown.Value) == nil then
...
function Library:CreateWindow(...)
    ...
    if isMobile or Config.Center then
    ...
    function Window:AddTab(Name)
        ...
        if isMobile then
            ...
            local ContentScrollFrame = Library:Create('ScrollingFrame', {
                BackgroundTransparency = 1,
                BorderSizePixel = 0,
                Position = UDim2.new(0, 0, 0, 0),
                Size = UDim2.new(1, 0, 1, 0),
            ...
            LeftSide = Library:Create('Frame', {
                BackgroundTransparency = 1,
                BorderSizePixel = 0,
                Position = UDim2.new(0, 8, 0, 8),
                Size = UDim2.new(1, -16, 0, 0),
                ZIndex = 2,
                Parent = ContentScrollFrame
            });
            ...
            LeftSide.ChildAdded:Connect(function()
                ...
                LeftSide.Size = UDim2.new(1, -16, 0, TotalHeight)
                ContentScrollFrame.CanvasSize = UDim2.new(0, 0, 0, TotalHeight + 16)
            end)
        else
            LeftSide = Library:Create('ScrollingFrame', {
                BackgroundTransparency = 1;
                BorderSizePixel = 0;
        ...
        function Tab:SetLayoutOrder(Position)
            ...
            if isMobile then
                TabArea:FindFirstChildOfClass('ScrollingFrame'):FindFirstChildOfClass('UIListLayout'):ApplyLayout();
            else
                TabArea:FindFirstChildOfClass('UIListLayout'):ApplyLayout();
            end
        end;
